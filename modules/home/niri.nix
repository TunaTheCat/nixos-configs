        ...
        settings = {
          ...
          binds =
            ...
            in
            {
              ...
              "Print" = bind "Screenshot (Copy)" { spawn = [ "screenshot" "--copy" ]; };
              ...
              "XF86AudioRaiseVolume" = bind "Volume Up" { spawn = [ "wpctl" "set-volume" "@DEFAULT_AUDIO_SINK@" "5%+" ]; };
              "XF86AudioLowerVolume" = bind "Volume Down" { spawn = [ "wpctl" "set-volume" "@DEFAULT_AUDIO_SINK@" "5%-" ]; };
              "XF86AudioMute" = bind "Mute" { spawn = [ "wpctl" "set-mute" "@DEFAULT_AUDIO_SINK@" "toggle" ]; };
              "XF86AudioPlay" = bind "Play/Pause" { spawn = [ "playerctl" "play-pause" ]; };
              "XF86AudioNext" = bind "Next Track" { spawn = [ "playerctl" "next" ]; };
              "XF86AudioPrev" = bind "Prev Track" { spawn = [ "playerctl" "previous" ]; };
            };
